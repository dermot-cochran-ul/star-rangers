...
const STORYLINE_THREADS = [
  ...
  },
  {
    ...
    // No seasons assigned yet - Season 2 was reassigned to undercover-pets
    // (2026-08-05, Dermot's call: its published chapters are the agency's
    // stories, not the task force's). Add season number(s) here once the
    // first Five-O chapter exists, per the church-space precedent below.
    seasons: []
  },
  {
    id: "church-space",
    name: "Church Space",
    // NOT a parallel storyline, despite living in a registry of them - this
    // description was corrected 2026-07-25 to match both the author's intent
    // and what is actually on disk. There are no church-space chapters and
    // `seasons` is deliberately empty; the content is lore, codex entries, a
