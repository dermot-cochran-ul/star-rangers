...
const STORYLINE_THREADS = [
  ...
  },
  {
    ...
    // S11E01C01 drafted 2026-09-06 at Dermot's ask, ahead of the endonym: every
    // name in it is rendered in translation and no naming system is taken, and
    // a Pandoid section of story-bible/mind-design.md was written first.
    ...
    // tiers above carry it and no narrowed face gains it by accident; the
    // children's edition that shows it extends `threads` when he names a domain.
    seasons: [11]
  },
  {
    id: "church-space",
