...
- **Rank does not transfer onto it.** A High Captain and a Chief who take it up on the same world start level. Whatever separates them twenty years later was earned in front of that world rather than in a service record it never sees. This preserves the liaisons page's original claim while replacing its reasoning — the equality is not because the standing is honorary, but because the path has its own ladder.
