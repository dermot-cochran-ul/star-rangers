...
- Technical excellence is insufficient without trust.
- Energy is more precious than time.
- Legacy is often transmitted through mentorship.
...
Two readings of the same faculty, decades apart.

At twenty-two: an attractive fellow student read as sarcastic and hostile. The
judgement arrived pre-formed, below the level of deliberation, and was never
tested — partly because her ordinary manner had never been observed as a
baseline, and partly because *simple miscommunication* was never generated as a
hypothesis at all. The error only surfaced years later, when something unrelated
brought the memory back.

Much later: the same pattern-detection fired on an online friend and was
**right**, catching several inconsistencies in their behaviour. The difference
