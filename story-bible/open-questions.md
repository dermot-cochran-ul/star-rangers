...
- **[The Enrolled Text](../src/lore/the-enrolled-text.md) and [The Amendment Atlas](../src/codex/the-amendment-atlas.md)**, drafted 22 August 2026 from his direction (a constitution kept like a versioned record: the founding compact as the original enrolment, amendments as reviewed differences, and a discussion of reading the amendment record as data for charting how rights move over centuries). Lore plus codex, so draft-and-stop: open until Dermot merges. Three things deliberately left open by the draft, all story hooks rather than gaps: whether anyone ever *draws* the Atlas (Corren's four sheets are proposed, not built — sheet one's "is the personhood line monotone?" is a question a future season could answer either way); whether **Ilsabet Corren** earns a character page or stays a byline; and whether *enrolled text* / *difference form* deserve glossary entries — institutional vocabulary, so not a canonical-glossary matter, but the terms are load-bearing enough that a glossary mirror (like `commissioned-standing`'s) may be worth it if they recur.
