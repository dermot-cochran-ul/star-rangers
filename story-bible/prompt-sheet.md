...
The first Ilveth portrait. The brief, the size caveat and the proposed alt text
live in `images.md` (Non-humanoid species section) — **do not paste until
Dermot has confirmed the proposed size axis recorded there.** Landscape;
file at 1200×675 per the character-portrait convention.
