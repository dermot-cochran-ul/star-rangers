...
**One piece of transit physics is scoped to it.** [Quantum space harmonic](/star-rangers/glossary/quantum-space-harmonic-wave/) corridor admissibility is drawn from the Archewright's archetypes, so the harmonic-wave FTL channel is specific to, and defined within, the local archecluster — the base quantum layer beneath the wave is universal, but which corridors are lawful is this cluster's vocabulary showing up in the route charts. This confers no authority and no adjacency, like everything else the cluster records. [Fold transit](/star-rangers/glossary/higher-dimensional-folding/) is scoped one tier higher, to the [formcluster](/star-rangers/glossary/formcluster/) and its manifold.
