...
**What a Worldwright does not make.** Creating the vessel creates its [cosmic membrane](/star-rangers/lore/concordant-membranes/) — a membrane being what a universe occupies by virtue of being one, not a skin fitted afterwards — but it does not make the [Common Manifold](/star-rangers/lore/post-eleven-dimensional-manifold/) the membrane is seated in. That is shared by every universe in the Grand Ensemble and is fixed as an Upper Structure condition, which is why its outermost band encodes boundary conditions Worldwright operations must *satisfy*. Nor is membrane-hood a Worldwright privilege: derived universes get no Worldwright and occupy membranes anyway, coherence rather than authorship being the criterion. **A Worldwright therefore cannot move its universe relative to any other.** Seating is not a thing anyone at this tier does.
