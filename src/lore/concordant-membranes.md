...
What separates one membrane from the next is the **[Interval](/star-rangers/glossary/interval/)** — manifold separation, measured across the Common Manifold rather than through any universe's own space. The Interval is not a place and not a medium anything travels through under its own power; no ship has ever been in it, and no being is native to it. It is the distance term in every boundary-zone measurement Survey Corps takes, and its only operationally interesting property is that it varies. Under a wide Interval, one Concordant's [Etheric](/star-rangers/glossary/etheric/) archetypal templates have no measurable reach into an adjacent one. The two membranes are real, adjacent, and functionally inert to each other.
...
[Boundary zones](/star-rangers/lore/boundary-zones/) are where the Interval narrows.
