...
- **Scale rule (settled 2026-07-26):** **A membrane is a universe, not a zone.** A Concordant Zone is a region *inside* a membrane; a universe holds many, and none of them is a membrane in its own right. One Worldwright authors **many** primary membranes — the unit of creation is the universe set, the unit of consistency is the zone. Earlier filings that read "each Concordant occupies its own membrane" are at the wrong scale; see the Migration Map.
...
| “each Concordant occupies its own membrane” / membrane used at zone scale | a membrane is a **primary universe**; a Concordant Zone is a region inside one | Scale correction, not a rename. Reread any passage where a *zone* is said to have a membrane, sit on one, or face another across an Interval. One Worldwright authors many primary membranes. |
