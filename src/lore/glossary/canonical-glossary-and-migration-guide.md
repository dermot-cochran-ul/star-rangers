...
- **Not a fold, and the distinction is load-bearing.** **Higher-dimensional folding** is engineered transit — scaffolded, transient, performed *inside* a single Concordant, in its thousands, and paired with **quantum space harmonic wave** as the long-range channel to QSHW's medium-range. A flexure is nobody's work, carries no traffic, and is not a route. The two share a shape and nothing else.
