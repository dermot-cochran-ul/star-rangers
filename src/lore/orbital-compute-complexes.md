...
title: "Orbital Compute Complexes"
category: "Technology"
...
None of them contains a quantum computer, and this is physics rather than policy. The [cavern constraint](/star-rangers/lore/quantum-computing-and-the-cavern-constraint/) already states it from the ground's side: a quantum machine needs an environment quiet on two decoherence channels at once, and an orbital platform is quiet on neither — no kilometres of overburden against the ordinary channel, and no cosmological shelter against the Etheric one. Quantum computing lives where it has always lived, in deep sealed caverns in stable, boundary-remote crust, and the orbital complexes carry everything else: ordinary computation and the [certified agentic systems](/star-rangers/lore/ai-safety-kernel/) run on classical substrates, which is why a complex can host resident intelligences, archives and simulation floors that no cavern vault could ever admit visitors to.
...
- [Quantum Computing and the Cavern Constraint](/star-rangers/lore/quantum-computing-and-the-cavern-constraint/) — why the vaults are underground and the complexes are not
- [The AI Safety Kernel](/star-rangers/lore/ai-safety-kernel/) — the certified agentic systems the complexes host
- [Aspenar](/star-rangers/lore/planets/aspenar/) — a Federation world whose orbital ring carries one of the largest complexes
- [FTL Mechanics](/star-rangers/lore/ftl-mechanics/) — no faster-than-light communication, between complexes or anyone else
