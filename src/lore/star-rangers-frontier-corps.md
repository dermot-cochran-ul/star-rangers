...
title: "The Star Rangers Frontier Corps"
...
In practice, the acute phase is usually mercifully short. Settled space is not empty: there is almost always a nearby authority — a parent polity, a neighbouring charter world, a regional body the Concordant recognises, the SSDC in the Solar System's own reach — that will assume jurisdiction within a few days of a collapse becoming known. The Corps' working doctrine for the *usual* case is therefore a bridge, not an occupation: hold the line, protect the vulnerable, preserve the evidence, and hand over to the assuming authority the moment it arrives — then leave, exactly as the caretaker clause would have required. Most second-landing files run to a week of Ranger presence and close clean.
...
- [Star Rangers Command Hierarchy](/star-rangers/lore/star-rangers-command-hierarchy/) — where the specialist corps sit
...
- [The Solar System Concordant](/star-rangers/lore/solar-system-concordant/) — the baseline law every compact incorporates
