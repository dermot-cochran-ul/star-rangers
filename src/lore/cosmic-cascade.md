...
A corollary, for readers of the operational record. Archive and Survey material routinely says that Telearchs "allocate," "coordinate," or produce "delayed but consistent correction," and that Dynarchs "administer" their forces — verbs with time in them, applied to strata that have none. Read these as descriptions of how a timeless mandate *manifests inside time*, not as events in the stratum's own existence. When an illegal cross-boundary manipulation is corrected three years after it began, the three years belong to the observers and to the time-bound tiers that executed the correction; what the Telearch stratum contributed was never an act on a date, but a mandate the correction was already inside. The banks do not move when the river bends around them.
