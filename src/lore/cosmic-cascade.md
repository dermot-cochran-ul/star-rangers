...
The shape is the same one the Conceptual layer takes, one tier up and one tier down. Conseleme fixes what any mathematics must satisfy; a Metawright settles which mathematics there is. Conseleme fixes what any time must satisfy; an Archewright settles which time there is.
