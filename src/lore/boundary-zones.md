...
Threshold Station and Marsh Causeway are linked by the same kind of edge behavior: both sit where a fold brings this membrane close to a neighbour, and their anomalies are lawful expressions of that proximity rather than supernatural exceptions.
