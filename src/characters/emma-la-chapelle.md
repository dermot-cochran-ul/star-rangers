...
Her objection to the word *discovery* is not modesty and she gets irritated when it is taken for modesty. Her position is arithmetical: she filed at low confidence because low confidence was what the evidence supported, the instruments were what settled it, and an officer who is right at the bottom of her range has been lucky rather than correct. She has said that if the analysis had come back empty the reading would have been exactly as good a piece of work, and that a branch which only remembers the ones that landed is training its people to file high.

The Kingdom's own account of the thing she found is that there is nothing to find — the terraces are old, the settlers worked hard, and the air is the air. La Chapelle has been careful not to press that, and careful in a specific direction: she has never put it to a Kingdom source that their chronicles are missing something. What she has done is ask what the word means when it is used of a wall, and of a catchment, and of a season, and written down each answer as given.

She is the delegation's most frequent visitor to the Abbeylands and the slowest producer of finished translations in it, which [Strozzi](/star-rangers/characters/ernesto-strozzi/) has recorded, in her assessments, as the correct ratio in that order.
