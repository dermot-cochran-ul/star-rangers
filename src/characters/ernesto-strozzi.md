...
- Has since submitted every substantial translation to the Abbey's own correctors before it reaches the Archive, an arrangement he proposed and the Abbess accepted without comment.
- Prepared the receiving file for [*What Prayer Is For*](/star-rangers/codex/what-prayer-is-for/) after a delegation linguist's question about the offices of the day produced a document nobody had asked for.

## Character Notes

The error is worth stating precisely, because the version that circulates in the branch has been smoothed. *Tribute* is not a wild reading of the word. It is the reading a competent linguist arrives at from the shape of the term and the fact of the render, and it is wrong for a reason no amount of corpus alignment would have surfaced: the Abbey holds its ground from the Crown directly, owing one fixed thing regardless of season, and a word rendered as tribute made the Kingdom's single deliberate exception to royal administration read, in the Solar System's first written account of it, as ordinary subjection. One word put the Abbeylands under Aduine's steward in the only record anyone off-world could consult.

Strozzi's account of what went wrong is not that he was careless. It is that the language was human, the cognate was real, and he let the second fact do work the first had not earned — which is the failure the school's whole temperament exists to prevent, arrived at by a practitioner who could recite that temperament before he made it.

He does not describe the nine months as a lesson. He describes them as the interval during which three postings read a false sentence, and he can name the three.

What he teaches now, when the branch asks him to, is the mechanism rather than the remorse: a confidence band is a claim about the claimer, not the claim, and the only honest use of a high band is one you would still have filed knowing it would sit uncorrected for a year. He has said, in the branch's hearing, that he would have filed it. He does not offer the sentence that would soften that, and appears not to have one.
