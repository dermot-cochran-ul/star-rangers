...
**Readers** (Dermot, later the same day): the Journal is not for the child reading the pets thread, and the children's edition deliberately carries none of it. It is for the parent or teacher reading that thread aloud, and beyond them for critics, reviewers, peer authors and students of the writing. The test before an entry publishes: would one of those readers learn something from it about how the work is made? The register above follows from these readers, not from the tier.
