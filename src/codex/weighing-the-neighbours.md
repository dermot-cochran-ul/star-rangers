...
location: "Survey Archive, Threshold Station — gravimetry working-paper series; filed 2825 UCSD, marked *proposal, not doctrine*"
tags: [cosmology, dark-matter, membrane-shadows, intermembrane-bleed, gravimetry, interval, working-paper, archive-doctrine]
description: "A Gravimetry Desk working paper proposing that some part of the dark component of the sky's mass budget is the summed gravitational imprint of neighbouring membranes at ordinary separation — a Membrane Shadow with no coherence, the whole neighbourhood's weight rather than one figure's — with the paper's own objections listed and its one testable prediction stated."
---
...
Two facts, both settled in the record, and both filed as facts about [gravity's own realm](/star-rangers/lore/the-scope-of-physical-law/) rather than about physics at large:

**Gravity registers across a narrowed [Interval](/star-rangers/glossary/interval/); electromagnetics never does.** That is the whole reason this station's cross-membrane gravimeters exist and its telescopes are ordinary. When a coherent mass stands close on the far side, we read a [Membrane Shadow](/star-rangers/lore/membrane-shadows/): a body's worth of gravity, resolved, with no body here to own it and no light from it at all. When the separation is wider, Class I or II, the same entry says the far side reads as noise, *indistinguishable from ordinary local-constant drift*.
...
**Some part of the dark component is the summed gravitational imprint of neighbouring membranes at ordinary separation.** The mechanism is the one the record already holds for a single figure at a Class III narrowing, with the coherence taken out: [dimensions 12 to 15 distribute geometric strain wherever membranes lie near each other](/star-rangers/lore/post-eleven-dimensional-manifold/), and that strain distribution is a real, bounded coupling between the two membranes' gravitational fields. At a narrowing the coupling is strong and the far-side mass is close and concentrated, so it resolves into a silhouette. Across the wide separations that are the ordinary condition of the [Grand Ensemble](/star-rangers/lore/ensemble-multiverse/), the coupling is weak, the far-side mass is a whole universe's worth spread across a whole membrane, and what arrives is a haze. **A Membrane Shadow is what one neighbour looks like standing close. The dark component is what all of them weigh from far away.**
